...
def find_theta(img):
    ...
    print(VanishingPoint[0], VanishingPoint[1])

    # Showing the final imagekdgkrl
    cv2.namedWindow('OutputImage', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('OutputImage', 1512, 1512)  # 1008, 756)
...
if __name__ == "__main__":
    Images, ImageNames = ReadImage("images")            # Reading all input images
    ...
    for i in range(len(Images)):
        ...
        # Drawing lines and vanishing pointqq
        for Line in Lines:
            cv2.line(Image, (Line[0], Line[1]), (Line[2], Line[3]), (0, 255, 0), 5)
        cv2.circle(Image, (int(VanishingPoint[0]), int(VanishingPoint[1])), 10, (0, 0, 255), -1)
    ...
    # image_path = "./images/KakaoTalk_20230504_180730891_26.jpg"
    # width, height = get_image_size(image_path)
    # center_x, center_y = width/2, height/2
    #
    # y_to_cy = center_y - VanishingPoint[1]
    #
    ...
    # arctan_degrees = math.degrees(arctan)
    # print(arctan_degrees)
